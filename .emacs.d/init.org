...
** Captures
   ...
   (setq org-capture-templates 
     (append org-capture-templates '(
	    ("p" "project" plain (file+headline "project.org" "Log") 
	    "    %?\n    %U\n %i\n  %a" :empty-lines 1)
...
#+END_SRC  
=======
>>>>>>> a016c067753d54c9cfc0d6a5d08fb44491978e75
...
*** Multilingual functionality for wiki-summary
    ...
    (let ((pre (concat "https://" (cdr (assoc (ido-completing-read "Open bookmark:" choices) choices))  ".wikipedia.org/w/api.php?continue=&action=query&titles="))
